...
<body>
    <div class="container">
        <div class="left-side">
        <h3 class="publication-title"><?php echo htmlspecialchars($publication->titreP); ?></h3>
            <div class="image-container">
                <img src="<?php echo !empty($publication->image_descriptive) ? htmlspecialchars($publication->image_descriptive) : htmlspecialchars($publication->document); ?>" alt="<?php echo htmlspecialchars($publication->titreP); ?>">
            </div>
        </div>
        <div class="right-side">
            <div class="details">
                <p><?php echo htmlspecialchars($publication->contenuP); ?></p>
                <?php
